...
class Empresa extends ModeloConLocalizacion
{
     ...
     * @param string $email
     * @param string $perfil
     * @param float|null $comision_comprador
     * @param float|null $comision_vendedor
     * @param string $categoria_crediticia
     * @param string $afinidad
    ...
    public function usuarioComercial() {
        return $this->hasOne(User::class, 'id', 'usuario_comercial_id');
    }
